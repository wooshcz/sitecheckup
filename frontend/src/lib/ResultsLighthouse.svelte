            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapse-{category.key}">Learn more</button>
                    </div>
                </div>
            </div>
        {/each}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {#if audit.scoreDisplayMode == "numeric"}
                                                    {formatScore(audit.numericValue, 1, 1)} {audit.numericUnit}
                                                {/if}
                                            </td>
                                        </tr>
                                    {/if}
